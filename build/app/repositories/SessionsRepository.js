...
let SessionsRepository = class SessionsRepository extends _1.BaseRepository {
    constructor(converter) {
        super(models_1.SessionsModel, converter);
    }
};
SessionsRepository = __decorate([
    inversify_1.injectable(),
    __param(0, inversify_1.inject(Types_1.TYPES.SESSIONS_CONVERTER)),
